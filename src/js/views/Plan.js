      ...
      <section class="options-section">
        ...
        <div class="option-container">
          ...
          <div class="options-container">
            ...
            <div class="option-box" data-option>
              <h2 class="option-title" data-option-title>Espresso</h2>
              <p class="option-description" data-option-description>
        ...
        <div class="option-container">
          ...
          <div class="options-container">
            <div class="option-box" data-option>
              <h2 class="option-title" data-option-title>Single Origin</h2>
              <p class="option-description" data-option-description>
            ...
            <div class="option-box" data-option>
              <h2 class="option-title" data-option-title>Blended</h2>
              <p class="option-description" data-option-description>
        ...
        <div class="option-container">
          ...
          <div class="options-container">
            <div class="option-box" data-option>
              <h2 class="option-title" data-option-title>250g</h2>
              <p class="option-description" data-option-description>
            ...
            <div class="option-box" data-option>
              <h2 class="option-title" data-option-title>1000g</h2>
              <p class="option-description" data-option-description>
        ...
        <div class="option-container">
          ...
          <div class="options-container">
            <div class="option-box" data-option>
              <h2 class="option-title" data-option-title>Whole Bean</h2>
              <p class="option-description" data-option-description>
            ...
            <div class="option-box" data-option>
              <h2 class="option-title" data-option-title>Cafetiére</h2>
              <p class="option-description" data-option-description>
        ...
        <div class="option-container">
          ...
          <div class="options-container">
            <div class="option-box" data-option>
              <h2 class="option-title" data-option-title>Every week</h2>
              <p class="option-description" data-option-description>
            ...
            <div class="option-box" data-option>
              <h2 class="option-title" data-option-title>Every month</h2>
              <p class="option-description" data-option-description>
